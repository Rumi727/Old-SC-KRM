...
namespace SCKRM.InspectorEditor
{
    ...
    [CustomEditor(typeof(CustomButtonRenderer), true)]
    public class CustomButtonRendererEditor : Editor
    {
        CustomButtonRenderer _editor;

        bool repaint = false;

        void OnEnable()
        {
            _editor = target as CustomButtonRenderer;
